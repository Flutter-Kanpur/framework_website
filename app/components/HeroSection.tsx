...
export default function HeroSection() {
    ...
    return (
        ...
        >
            ...
            {/* ═══════ 3D FLOATING MASCOT ═══════ */}
            <motion.div
                style={{ y: mascotY, rotate: mascotRotate, scale: mascotScale, opacity: bgOpacity }}
            ...
            >
                ...
                <motion.div style={{ y: titleY, scale: titleScale, rotateX: titleRotateX }} className="mb-4 [perspective:1000px]">
                ...
                <motion.div style={{ y: subtitleY, filter: useTransform(subtitleBlur, (v) => `blur(${v}px)`) }}>
                    <motion.p
                    ...
                    >
                        Annual Hackathon & Tech Conference — Where developers
                        converge to{" "}
                ...
                >
                    ...
                    <motion.a
                        href="#register"
                        whileHover={{ scale: 1.06, boxShadow: "0 0 40px rgba(65,103,242,0.5)" }}
                        whileTap={{ scale: 0.96 }}
                ...
                <motion.div style={{ y: statsY }} className="max-w-3xl mx-auto px-2">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
                        {[
                            { value: "500", suffix: "+", label: "Attendees", delay: 1.8 },
                            { value: "20", suffix: "+", label: "Speakers", delay: 2.0 },
                            { value: "8", suffix: "", label: "Tracks", delay: 2.2 },
                            { value: "48", suffix: "h", label: "of Innovation", delay: 2.4 },
                        ].map((stat) => (
                            <motion.div
                                key={stat.label}
                                initial={{ opacity: 0, y: 30 }}
