      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed mb-6">
            Framework is a community-driven tech conference and hackathon designed to
            bring developers, innovators, and tech enthusiasts together to learn,
            build, and collaborate.
          </p>

          <p className="text-zinc-400 text-lg leading-relaxed">
            Organized by the <span className="text-white font-medium">Flutter Kanpur Community</span>, the event features insightful
            talks from industry experts, hands-on sessions, and an exciting hackathon
            where participants can turn ideas into real solutions.
          </p>
