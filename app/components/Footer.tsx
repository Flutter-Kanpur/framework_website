        ...
        <footer className="relative overflow-hidden border-t border-white/5">
            ...
            <div className="relative py-20 overflow-hidden">
                ...
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] opacity-10"
                    style={{ background: "radial-gradient(ellipse, #4167F2, transparent 70%)" }}
                />
                ...
                <AnimatedSection className="text-center">
                    ...
                    <div className="mt-[-2rem] md:mt-[-4rem] relative z-10">
                        ...
                        <p className="mt-3 text-gray-400 text-sm" style={{ fontFamily: "var(--font-inter)" }}>
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <div className="flex items-center gap-2 mb-4">
                            <Image
                                ...
                                height={32}
                            />
                            <span className="text-white text-sm tracking-widest" style={{ fontFamily: "var(--font-michroma)" }}>
                                FRAMEWORK
                            </span>
                        </div>
                        <p className="text-sm text-gray-500 leading-relaxed" style={{ fontFamily: "var(--font-inter)" }}>
                            Flutter Kanpur&apos;s annual hackathon and tech conference bringing developers together.
                        </p>
                    </div>
            ...
            <div className="absolute inset-0 pointer-events-none opacity-[0.02]">
                <div className="w-full h-full"
                    style={{
                        backgroundImage: "linear-gradient(#4167F2 1px, transparent 1px), linear-gradient(90deg, #4167F2 1px, transparent 1px)",
