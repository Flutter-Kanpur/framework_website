...
const YOUTUBE_VIDEO_ID_WEB = "u2BmTNJT4To";
...
export default function FrameworkScrollSection() {
  ...
  const [thumbSrc, setThumbSrc] = useState(
    getThumbnailUrl(YOUTUBE_VIDEO_ID_WEB),
  );
            ...
            <>
              ...
              {isMuted && (
                <button
                  ...
                  className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 px-4 py-2 rounded-full bg-black/60 hover:bg-black/80 flex items-center gap-2 text-white text-sm backdrop-blur-sm border border-white/20 transition-colors"
